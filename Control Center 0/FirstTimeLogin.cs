...
{
    public partial class FirstTimeLogin : UserControl
    {
        public FirstTimeLogin(OnPasswordEntered passwordEntered, string mainText)
        {
            ...
            textBoxSecondPassword.PasswordChar = '*';
        ...
        private void buttonCommittPassword_Click(object sender, EventArgs e)
        {
            ...
            string pw2 = textBoxSecondPassword.Text;

            if (pw1 != pw2)
            {
                textBoxStatus.Text = "Passwords do not match, please retry";
                textBoxStatus.ForeColor = Color.Red;
