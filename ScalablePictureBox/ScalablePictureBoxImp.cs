...
/// </summary>
namespace ScalablePictureBoxTool
{
	/// <summary>
    ...
    internal partial class ScalablePictureBoxImp : System.Windows.Forms.UserControl
    {
        ...
        /// </summary>
        private int currentScalePercent=100;// = MAX_SCALE_PERCENT;
		...
		public ScalablePictureBoxImp()
		{
            ...
            // Read icon images
            fitWidthImage = Util.GetImageFromScalablePictureBoxEmbeddedResource("ScalablePictureBoxTool.showFitWidth.gif");
            showWholeImage = Util.GetImageFromScalablePictureBoxEmbeddedResource("ScalablePictureBoxTool.showWhole.gif");
            showActualSizeImage = Util.GetImageFromScalablePictureBoxEmbeddedResource("ScalablePictureBoxTool.showActualSize.gif");

            // read cursors
            zoomInCursor = Util.CreateCursorFromFile("ScalablePictureBoxTool.ZoomIn32.cur");
            zoomOutCursor = Util.CreateCursorFromFile("ScalablePictureBoxTool.ZoomOut32.cur");
